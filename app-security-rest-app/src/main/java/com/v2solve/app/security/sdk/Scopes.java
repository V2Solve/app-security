...
public class Scopes 
{
	...
	{
		return new Scope ("NONAME",SCOPE_ASSIGN_GROUP_TO_CLIENT,value,null,null);
	}

	public static Scope assignRoleToGroupScope (String value)
	{
		return new Scope ("NONAME",SCOPE_ASSIGN_ROLE_TO_GROUP,value,null,null);
	}

	public static Scope clientRoleScope (String value)
	{
		return new Scope ("NONAME",SCOPE_CLIENT_ROLE,value,null,null);
	}
	
	public static Scope assignPermissionToRoleScope (String value)
	{
		return new Scope ("NONAME",SCOPE_ASSIGN_PERMISSION_TO_ROLE,value,null,null);
	}
	

	public static Scope clientGroupScope (String value)
	{
		return new Scope ("NONAME",SCOPE_CLIENT_GROUP,value,null,null);
	}
